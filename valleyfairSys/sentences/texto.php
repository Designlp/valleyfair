...
$LNG['welcome_title'] = 'Bienvenido de nuevo';
...
$LNG['ttl_friendship_confirmed_email'] = '%s aceptó tu solicitud de amistad';
...
$LNG['delete_q_chat'] = '¿Estas seguro de borrar este mensaje?';
...
$LNG['share'] = '<div class="shareD"></div>';
$LNG['camera'] = 'Camara';
$LNG['capture'] = 'Captura';
$LNG['send'] = 'Enviar';
...
$LNG['sidebar_friendships'] = 'Amigos';
...
$LNG['label_video'] = 'Comparte el vinculo de YouTube o Video de tu Proyecto';
...
$LNG['admin_ttl_sentences']			= $LNG['admin_menu_sentences'] 		= 'Idiomas';
...
$LNG['get_sentences'] = 'Obtenga más idiomas';
...
$LNG['new_comment_notification'] = '<a href="%s" rel="loadpage">%s</a> comentó en tu <a href="%s" rel="loadpage">publicación</a>';
$LNG['new_shared_notification'] = '<a href="%s" rel="loadpage">%s</a> compartió tu <a href="%s" rel="loadpage">publicación</a>';
...
$LNG['new_friend_notification'] = '<a href="%s" rel="loadpage">%s</a> aceptó tu solicitud de amistad';
$LNG['new_chat_notification'] = '<a href="%s" rel="loadpage">%s</a> te envió un nuevo <span class="desktop"><a onclick="%s">mensaje de chat</a></span><span class="mobile"><a href="%s" rel="loadpage">mensaje de chat</a></span>';
$LNG['new_birthday_notification'] = '<a href="%s" rel="loadpage">%s</a> está de cumpleaños';
$LNG['years_old'] = '%s años';
$LNG['x_and_x_others'] = '<a href="%s" rel="loadpage">%s</a> y <a href="%s" rel="loadpage">%s más</a>';
$LNG['new_like_fa'] = '<a href="%s" rel="loadpage">%s</a> le gustó una <a href="%s" rel="loadpage">publicación</a>';
$LNG['new_like_c_fa'] = '<a href="%s" rel="loadpage">%s</a> le gustó un <a href="%s" rel="loadpage">comentario</a>';
$LNG['new_comment_fa'] = '<a href="%s" rel="loadpage">%s</a> comentó en una <a href="%s" rel="loadpage">publicación</a>';
...
$LNG['none'] = 'Ninguno';
$LNG['pages'] = 'Páginas';
$LNG['search_for_people'] = 'busca personas y';
$LNG['search_pages'] = '';
